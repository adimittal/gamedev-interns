    ...
    .defines(function () {
        ...
        wm.config = {
            project: {
                ...
                'gameKey': 'revolt', // match folder name
                'modulePath': 'revolt/',
                ...
                'entityFiles': 'revolt/entities/*.js',
                // The default path for the level file selection box
                'levelPath': 'revolt/levels/',
            ...
            'collisionTiles': {
                'path': 'revolt/weltmeister/collisiontiles-64.png',
                'tilesize': 64
            },
            ...
            // to change these.
            'api': {
                'save': `${baseUrl}/welt/save`,
                'browse': `${baseUrl}/welt/browse`,
                'glob': `${baseUrl}/welt/entities`,
                // 'save': 'weltSave',
                // 'browse': 'weltBrowse',
                // 'glob': 'weltGlob'
            }
