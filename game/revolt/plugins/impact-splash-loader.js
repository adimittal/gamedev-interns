ig.module(
    ...
    .defines(function () {
        ...
        background.src = "http://coreu.com/dw_blog/money_clouds.jpg";
        ig.ImpactSplashLoader = ig.Loader.extend({
            ...
            draw: function () {
                ...
                ctx.textAlign = 'right';
                ctx.font = '10px Arial';
                ctx.fillText('http://a1.acmetutor.com', w - 10, h - 10);
                ctx.textAlign = 'left';
...
// Fill with gradient
                ...
                ctx.fillText("Acmetutor revolt!", 10, 50);
                ctx.font = "20px Georgia";
                ctx.fillText("by Aditya Mittal!", 10, 90);
